...
from Ai.ai_route_utils import redis_and_db_worker_status
...
from Ai.ai_services import file_validation_service
...
async def upload_doc(
    ...
    result: APIResponse = await file_validation_service(file=file, user_jwt_payload=user_jwt_payload)
